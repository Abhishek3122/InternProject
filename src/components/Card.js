...
function CardContent(props) {
  return (
    <div className="styleCardContent">
      ...
      <p className="styleDescription">{props.Venue}</p>
      <p className="styleDescription">{props.description}</p>
      <p className="styleDescription">{props.confUrl}</p>
      <p className="styleDescription">{props.entryType}</p>
    </div>
  );
}
